...
AS	
	...
	--BEGIN
		...
		ORDER BY	O_GRUPO_TAG		,D_SISTEMA_TAG_MENU
	--END
	-- /////////////////////////////////////////////////////////////////////
GO
...
BEGIN TRY
	...
	BEGIN
		...
		RAISERROR (@VP_MENSAJE, 16, 1 )
	END
	--																		--	GERENTES Y GENERICO (PLG)
	IF @PP_K_USUARIO_ACCION	NOT IN (41,139,144,150) AND @PP_K_USUARIO_PEARL IN (42,43,44,47,56,60,62,210,179)
	BEGIN																									 		
		SET @VP_MENSAJE='El USUARIO_PEARL no puede ser modificado(UP). [USUARIO_PEARL#'+CONVERT(VARCHAR(10),@PP_K_USUARIO_PEARL)+']'
		RAISERROR (@VP_MENSAJE, 16, 1 )
	END
