...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_USUARIO_INCONVENIENTE]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_USUARIO_INCONVENIENTE]
GO
...
CREATE PROCEDURE [dbo].[PG_USUARIO_INCONVENIENTE]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO_ACCION		INT,
	-- ===========================
...
DECLARE @VP_CU_D_USUARIO_FINAL NVARCHAR(MAX)='',	@VP_EXISTE	INT=1,	@VP_INCONVENIENTE	INT=1
	...
	END
		...
		WHILE @@FETCH_STATUS = 0
		   ...
		   BEGIN
				EXECUTE	[dbo].[PG_USUARIO_INCONVENIENTE]	@PP_K_SISTEMA_EXE , @PP_K_USUARIO_ACCION,
															-- ===========================
...
-- EXECUTE [dbo].[PG_SK_USUARIO_PEARL_NUEVO] 0,139,13164
...
--DECLARE @VP_MENSAJE		NVARCHAR(MAX) = '', @VP_ERROR_TRANS		NVARCHAR(MAX)
--BEGIN TRY
--IF (( SELECT COUNT(K_SKILL) FROM SKILL WHERE K_PUESTO = @PP_K_PUESTO AND K_ESTATUS_SKILL = 0 ) > 0 
...
--			K_USUARIO_PEARL AS CODIGO,
		...
		--IF @@ROWCOUNT=0
		--BEGIN
		--	RAISERROR ('EL EMPLEADO NO EXISTE', 16, 1 ) --MENSAJE - Severity -State.
		--END
--END TRY
--BEGIN CATCH	
--	SET @VP_ERROR_TRANS = ERROR_MESSAGE() 
--	SET @VP_MENSAJE = 'ERROR:// ' + @VP_ERROR_TRANS + ', #['+CONVERT(nvarchar(MAX),@PP_K_EMPLEADO_PEARL)+']'
...
--				'TEST200230IT' , 'TEST200201IT@TEST.USUARIO_PEARL' , '6660000000' , 30 , 
--				1,0,
...
-- /////////////////////////////////////////////////////////////////////
		...
		EXECUTE [BD_GENERAL].dbo.[PG_SK_CATALOGO_K_MAX_GET]		@PP_K_SISTEMA_EXE, 'COMPRAS',
																'ADDRESS_USUARIO_PEARL', 'K_ADDRESS_USUARIO_PEARL',
																@OU_K_TABLA_DISPONIBLE = @VP_K_ADDRESS_USUARIO_PEARL	OUTPUT		

		EXECUTE [BD_GENERAL].dbo.[PG_SK_CATALOGO_K_MAX_GET]		@PP_K_SISTEMA_EXE, 'COMPRAS',
																'CONTACT_USUARIO_PEARL', 'K_CONTACT_USUARIO_PEARL',
																@OU_K_TABLA_DISPONIBLE = @VP_K_CONTACT_USUARIO_PEARL	OUTPUT
		
	-- /////////////////////////////////////////////////////////////////////
	IF @VP_MENSAJE=''
		EXECUTE [dbo].[PG_RN_USUARIO_PEARL_INSERT]		@PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
												@VP_K_USUARIO_PEARL, 
	...
	IF @VP_MENSAJE=''
		EXECUTE [dbo].[PG_RN_USUARIO_PEARL_UNIQUE]		@PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
												@VP_K_USUARIO_PEARL, 
												@PP_D_USUARIO_PEARL, @PP_RFC_USUARIO_PEARL,
												@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
	...
	--============================================================================
		INSERT INTO USUARIO_PEARL
			(	[K_USUARIO_PEARL], [D_USUARIO_PEARL], 
				[C_USUARIO_PEARL], [O_USUARIO_PEARL],
				-- ===========================
				[BUSINESS_NAME], [RFC_USUARIO_PEARL], 
				[EMAIL], [PHONE], 
				[N_CREDIT_DAYS],
				-- ===========================
				[K_STATUS_USUARIO_PEARL],[K_CATEGORY_USUARIO_PEARL],
				-- ===========================
				[K_USUARIO_ALTA], [F_ALTA], [K_USUARIO_CAMBIO], [F_CAMBIO],
				[L_BORRADO], [K_USUARIO_BAJA], [F_BAJA]  )
		VALUES	
			(	@VP_K_USUARIO_PEARL, @PP_D_USUARIO_PEARL, 
				@PP_C_USUARIO_PEARL, 10,
				-- ===========================
				@PP_D_USUARIO_PEARL, @PP_RFC_USUARIO_PEARL, 
				@PP_EMAIL, @PP_PHONE,
				@PP_N_CREDIT_DAYS,
				-- ===========================
				@PP_K_STATUS_USUARIO_PEARL, @PP_K_CATEGORY_USUARIO_PEARL,
				-- ============================
