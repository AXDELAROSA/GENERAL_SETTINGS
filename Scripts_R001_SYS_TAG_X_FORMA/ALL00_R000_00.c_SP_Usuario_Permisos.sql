...
AS
	...
	SELECT	TOP (5000)
			...
			D_DEPARTAMENTO					AS DEPARTAMENTO_NOMBRE,
			S_DEPARTAMENTO					AS DEPARTAMENTO_ALIAS,
			-- ======================================================
			...
			(	CASE
					WHEN	K_USUARIO_PEARL	IN	(41,139,144,150)	THEN	''
...
AS	
	-- =========================================
		SELECT DISTINCT		
					...
					D_SISTEMA_TAG_MENU
		FROM		USUARIO_PEARL		(NOLOCK) 
		INNER JOIN	USUARIO_PERMISOS	(NOLOCK) ON USUARIO_PEARL.K_USUARIO_PEARL	= USUARIO_PERMISOS.K_USUARIO_PEARL
		INNER JOIN	SISTEMA_TAG			(NOLOCK) ON USUARIO_PERMISOS.K_SISTEMA_TAG	= SISTEMA_TAG.K_SISTEMA_TAG
		INNER JOIN	GRUPO_TAG			(NOLOCK) ON SISTEMA_TAG.K_GRUPO_TAG			= GRUPO_TAG.K_GRUPO_TAG
...
--		 EXECUTE [dbo].[PG_LI_USUARIO_PERMISOS_SISTEMA_TAG_MENU] 0,139,139,10
--		 EXECUTE [dbo].[PG_LI_USUARIO_PERMISOS_SISTEMA_TAG_MENU] 0,139,87,10
...
AS
	-- =========================================
	IF @PP_K_GRUPO_TAG	IN (@PP_K_GRUPO_TAG)
		SELECT	DISTINCT		
					SISTEMA_TAG.K_GRUPO_TAG,
					SISTEMA_TAG.K_SISTEMA_TAG,
...
AS
	...
	LEFT JOIN	HOWE.DBO.VISTA_GAFETES		(NOLOCK) ON EN_NUM_EMP=K_EMPLEADO_PEARL
	LEFT JOIN	DEPARTAMENTO				(NOLOCK) ON USUARIO_PEARL.K_USUARIO_DEPARTAMENTO	= DEPARTAMENTO.DP_DEPTO_HOWE
	WHERE	USUARIO_PEARL.L_BORRADO						<> 1
...
-- =========================================	
	DECLARE	 @VP_MENSAJE					VARCHAR(500)
			...
			-- ===========================
			,@VP_K_USUARIO_DEPARTAMENTO		INTEGER
...
BEGIN TRY
	...
	BEGIN
		...
		SET		@VP_K_USUARIO_DEPARTAMENTO	= NULL
		SET		@VP_K_CLASE_DEPARTAMENTO	= NULL
	...
	END
		...
		--=======================================================
				...
				@VP_K_CLASE_DEPARTAMENTO= K_USUARIO_DEPARTAMENTO,
				@VP_D_DEPARTAMENTO		= USUARIO_PEARL.K_CLASE_DEPARTAMENTO
		--=======================================================
		FROM	USUARIO_PEARL		(NOLOCK) 
...
END CATCH
	...
	SELECT	@VP_MENSAJE					AS MENSAJE,
			...
			@VP_K_USUARIO_DEPARTAMENTO	AS K_USUARIO_DEPARTAMENTO,
