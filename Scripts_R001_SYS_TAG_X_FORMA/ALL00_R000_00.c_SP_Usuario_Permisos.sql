...
--IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_LI_GRUPO_TAG_MENU]') AND type in (N'P', N'PC'))
--	DROP PROCEDURE [dbo].[PG_LI_GRUPO_TAG_MENU]
--GO

---- EXECUTE [dbo].[PG_LI_GRUPO_TAG_MENU] 0,139,139
--CREATE PROCEDURE [dbo].[PG_LI_GRUPO_TAG_MENU]
--	@PP_K_SISTEMA_EXE			INT,
--	@PP_K_USUARIO_ACCION		INT,
--	-- ===========================
--	@PP_K_USUARIO_PEARL			INT
...
-- EXECUTE [dbo].[PG_LI_SISTEMA_TAG] 0,139,139,10
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_SK_SISTEMA_TAG]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_SK_SISTEMA_TAG]
GO

-- EXECUTE [dbo].[PG_SK_SISTEMA_TAG] 0,139,001
-- EXECUTE [dbo].[PG_SK_SISTEMA_TAG] 0,139,002
-- EXECUTE [dbo].[PG_SK_SISTEMA_TAG] 0,139,020
-- EXECUTE [dbo].[PG_SK_SISTEMA_TAG] 0,139,021
CREATE PROCEDURE [dbo].[PG_SK_SISTEMA_TAG]
	@PP_K_SISTEMA_EXE				INT,
	@PP_K_USUARIO_ACCION			INT,
	-- ===========================
	@PP_K_SISTEMA					INT
AS
		SELECT	
				C_SISTEMA_TAG	AS RUTA,
				L_FORMA_TAG		AS TIPO_FORMA 
		FROM	SISTEMA_TAG
		WHERE	K_SISTEMA_TAG=@PP_K_SISTEMA
		AND		L_SISTEMA_TAG<>0
	-- /////////////////////////////////////////////////////////////////////
GO
