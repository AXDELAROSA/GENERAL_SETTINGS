...
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 65, 74,	70 -- FERNANDOG /  BTN_IMPORT_MANUAL
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 66, 74,	41 -- RAFAELF /  BTN_IMPORT_MANUAL
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 67, 74,	144 -- FEG /  BTN_IMPORT_MANUAL
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 68, 74,	120 -- ALFREDOA /  BTN_IMPORT_MANUAL
