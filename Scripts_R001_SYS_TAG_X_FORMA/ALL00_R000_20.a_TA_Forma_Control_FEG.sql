...
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 23, 22,	41 -- RAFAELF / TextBox3
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 24, 23,	41 -- RAFAELF / BOTON Button1
...
SELECT  K_USUARIO_TIPO AS TIPO ,* FROM USUARIO_PEARL 
WHERE K_USUARIO_TIPO IN (10,20,40,50) 
AND K_USUARIO_PEARL IN (SELECT * FROM USUARIO_PERMISOS WHERE K_SISTEMA_TAG = 6)

10	ADMINISTRADOR A1	A1
20	ADMINISTRADOR Q1	Q1
30	USUARIO GENERAL	U
...
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 208, 114,	139	-- AX			/ CONFIRMAR FECHA RECIBIDO
EXECUTE [dbo].[PG_CI_SISTEMA_CONTROL_PERMISO] 0, 0, 209, 114,	57	-- FABIOLA		/ CONFIRMAR FECHA RECIBIDO
