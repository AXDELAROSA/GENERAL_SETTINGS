...
--=========PARA DESCRIPCION DE PUESTOS========================================
EXECUTE [dbo].[PG_CI_TIPO_GRUPO_APROBADOR] 0, 0, 4, 'MQU SALIDA',					'MQU_SAL', 4, '', 1
GO
...
EXECUTE [dbo].[PG_CI_GRUPO_APROBADOR] 0, 0, 4, 'AUTORIZAR SALIDA MQU',					'AUT_SAL_MQU', 144, 4, 0
EXECUTE [dbo].[PG_CI_GRUPO_APROBADOR] 0, 0, 5, 'AUTORIZAR SALIDA MQU',					'AUT_SAL_MQU', 89, 4, 1
GO
