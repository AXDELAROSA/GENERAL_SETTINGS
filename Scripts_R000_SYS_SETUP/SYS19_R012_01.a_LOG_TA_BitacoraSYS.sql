...
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS]	0, 0, 'NULA',		'NULA',  00, '' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 1, 'MUY BAJA',	'MYBJA', 10, '' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 2, 'BAJA',		'BAJA',  20, 'SELECT/SEEK' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 3, 'MODERADA',	'MODRD', 30, 'INSERT/UPDATE' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 4, 'ALTA',		'ALTA',  40, '' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 5, 'MUY ALTA',	'MYALT', 50, 'DELETE' 
EXECUTE [dbo].[PG_CI_IMPORTANCIA_BITACORA_SYS] 	0, 6, 'CRITICA',	'CRITC', 60, '' 
GO
...
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,0, 'DEBUGEO',			'DEBUG', 20, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,1, 'NINGUNO',			'NINGN', 20, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,2, 'MONITOREO',		'MONIT', 10, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,3, 'AUTORIZACION',	'AUTRZ', 10, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,4, 'ALERTA',			'ALERT', 20, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,5, 'BD/SQL',			'SQLBD', 20, '' 
EXECUTE [dbo].[PG_CI_CLASE_BITACORA_SYS]	0,6, 'TRANSACCION/USR',	'TRANS', 20, '' 
GO
...
EXECUTE [dbo].[PG_CI_GRUPO_BITACORA_SYS] 0, 1, 'BACKUP',	'BCKUP', 10, '' 
EXECUTE [dbo].[PG_CI_GRUPO_BITACORA_SYS] 0, 2, 'GRUPO 2',	'GPO2',  20, '' 
EXECUTE [dbo].[PG_CI_GRUPO_BITACORA_SYS] 0, 3, 'OPERACION',	'OPERA', 20, '' 
GO
