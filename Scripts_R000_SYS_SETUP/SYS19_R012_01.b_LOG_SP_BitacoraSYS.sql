...
-- EXECUTE [dbo].[PG_LI_BITACORA_SYS] 0,0,0, '11/NOV/2019', -1, -1, -1, 'TEST'
...
AS
	...
	FROM	SISTEMA,
			...
			BITACORA_SYS
			BITACORA_SYS LEFT JOIN [DATA_02].[dbo].[USERS_PEARL]
				ON BITACORA_SYS.K_USUARIO=USERS_PEARL.CODIGO
	...
	AND		(	D_BITACORA_SYS		LIKE '%'+@PP_D_BITACORA_SYS+'%' 
			...
			OR  STORED_PROCEDURE	LIKE '%'+@PP_D_BITACORA_SYS+'%' 	
				-- ===========================================
			OR  USUARIO				LIKE '%'+@PP_D_BITACORA_SYS+'%' 	
				-- ===========================================
...
AS
	...
	EXECUTE [dbo].[PG_IN_BITACORA_SYS]	--@PP_L_DEBUG, 
										@PP_K_SISTEMA_EXE, @PP_K_USUARIO,
										-- ===========================================
										@PP_K_CLASE_BITACORA_SYS, @PP_K_IMPORTANCIA_BITACORA_SYS, @PP_K_GRUPO_BITACORA_SYS,
										@PP_D_BITACORA_SYS, @PP_C_BITACORA_SYS,
										-- ===========================================
...
AS
	...
	EXECUTE [dbo].[PG_IN_BITACORA_SYS_BASICO]	--@PP_L_DEBUG, 
												@PP_K_SISTEMA_EXE, @PP_K_USUARIO,
												@PP_K_CLASE_BITACORA_SYS, @PP_K_IMPORTANCIA_BITACORA_SYS, @PP_K_GRUPO_BITACORA_SYS,
												-- ===========================================
												-- @PP_D_BITACORA_SYS, @PP_C_BITACORA_SYS,
...
AS
	...
	EXECUTE [dbo].[PG_IN_BITACORA_SYS_JOB_LIMITE]	--@PP_L_DEBUG, 
													@PP_K_SISTEMA_EXE, @PP_K_USUARIO,
													@PP_NIVEL,
													@PP_K_CLASE_BITACORA_SYS, @PP_K_IMPORTANCIA_BITACORA_SYS, @PP_K_GRUPO_BITACORA_SYS
