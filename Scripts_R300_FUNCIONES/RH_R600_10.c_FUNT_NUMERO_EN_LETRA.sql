...
-- // OPERACION:		CANTIDADES EN LETRAS
-- //////////////////////////////////////////////////////////////
-- // Autor:			FEG
...
-- //////////////////////////////////////////////////////////////
--	DROP FUNCTION [dbo].[FN_CANTIDAD_EN_LETRA]

/*
  SELECT [BD_GENERAL].dbo.FN_CANTIDAD_EN_LETRA(600.50)
*/

CREATE FUNCTION [dbo].[FN_CANTIDAD_EN_LETRA]
(
    @Numero             Decimal(18,2)
)
RETURNS Varchar(180)
